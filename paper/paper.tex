...
The properties include the independence number, number of independent set of a given size, and enumeration of independent sets of a give size.
...
Here is a short introduction to the functionalities in this libary.
