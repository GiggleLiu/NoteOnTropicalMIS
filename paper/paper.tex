...
Our generic programming tensor network method can be used to compute properties of other problems like cut size, colouring, maximal cliques et al.
...
while dynamic programming approaches~\cite{Courcelle1990, Fomin2013} works better for graphs with a small tree width $\text{tw}(G)$, and
...
In this paper, we do not limit our discussion to finding one of the maximum independent sets and its size.
