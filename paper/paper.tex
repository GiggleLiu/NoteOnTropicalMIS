...
In graph theory and combinatorial optimization, there is an important class of problems that can rephrased as satisfiability problems quantified over local sets that typically consists of a vertex and its neighborhood,
...
\end{figure}
\purple{There are some other ideas I have to add to this...}
