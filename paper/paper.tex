...
We also computed hard square entropies for these lattices and shown the results in \Fig{fig:hardsquare}.
...
\begin{figure}[t] 
    ...
    \caption{Hard square entropy for lattices defined in \Fig{fig:lattices}, the error bar is scaled by a factor of $100$.}
