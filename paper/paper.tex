...
\texttt{OMEinsumContractionOrders} for hyper optimized contraction order (the KaHyPar~\cite{Schlag2020} approach) ~\cite{Gray2021,Pan2021}.
...
The result is a scalar function of $x$, it corresponds to the independence polynomial~\cite{Ferrin2014}.
\begin{equation}
...
What we need is computing with the finite field algebra. In a finite field algebra $GF(p)$, we have the following observations
\begin{enumerate}
