...
\section{Three approaches to computing independence polynomial}
...
\end{equation}
the contraction of this einsum network generates the independence polynomial %, we denote this contraction as \texttt{a,b,c,d,ab,ad,bc,bd,cd,ce->}.
\begin{equation}
...
Here if we are only interested in obtaining $\alpha(G)$ and omit the factors, the algebra of $x$ corresponds to the tropical algebra~\cite{Maclagan2015,Moore2011}.
