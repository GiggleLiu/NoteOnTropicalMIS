...
In this paper, we focus on the less studied \textit{solution space property} computation which can be harder, e.g. counting independent sets of a general graph is \#P-complete~\cite{Vadhan2001}, but is crutial towards understanding a hard problem.
...
\begin{figure} 
    \begin{subfigure}[t]{\textwidth}
        ...
        \caption{King's graphs of size $20\times 20$, $0.8$ filling.}
    \end{subfigure}
    \begin{subfigure}[t]{\textwidth}
        \centering
        %\includegraphics[width=\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{figures/fig3.pdf}
        ...
        \caption{Random three regular graphs of size $110$.}
    \end{subfigure}
