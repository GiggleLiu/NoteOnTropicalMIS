...
\begin{figure} 
    ...
    Legends are properties, data types and devices that we used in the computation, one can find the corresponding computed property in \Tbl{tbl:generictypes}.
