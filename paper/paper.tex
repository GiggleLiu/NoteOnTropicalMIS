...
Here the main function \texttt{solve} takes two inputs, the problem instance of type \texttt{IndependentSet} and the property instance of type \texttt{GraphPolynomial}, while the problem instance also takes two arguments to initialize, one is the graph instance one wants to solve and the key word argument \texttt{optimizer} is for tensor network optimization.

\centering{\includegraphics[width=0.8\textwidth, trim={0cm 1cm 0cm 1cm}, clip]{figures/fig7.pdf}}
