...
however, tensor network has richer algebraic structure, and this structure is crutial for property computation.
...
\begin{figure} 
    \centering
    \includegraphics[width=.65\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{paper/figures/exp_configurations.pdf}
