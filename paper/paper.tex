...
Previous dynamic programming approach~\cite{Courcelle1990,Fomin2013} can reduce the complexity of computing to $O(2^{tw(G)}tw(G)n)$.
...
It is related to hard spheres lattice gas model~\cite{Dyre2016}, and Rydberg hamiltonian~\cite{Pichler2018}.

In this work, we attack this problem by mapping it to an ``einsum'' network.
...
One can generalize the generic einsum network for solving another \#P-complete problem, the matching polynomials.
