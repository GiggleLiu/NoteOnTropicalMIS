...
this time complexity is the same as the dynamic programming algorithm~\cite{Courcelle1990, Fomin2013}.
These two algorithms are related but are not equivalent.
Dynamic programming is more general purposed, while a tensor network has a richer algebraic structure, and this structure is crutial for solution space property computation.
