...
In this paper, we focus on independent set \textit{property} computation. % We introduce a generic programming tensor-network framework to compute the various \textit{properties} pertaining to independent sets. 
