...
The algorithmic complexity of this approach is $2^{{\rm tw}(\overline G)}$, where ${\rm tw} (\overline G)$ is the treewidth of the line graph of the tensor network graph $G$.
...
\begin{figure}[t] 
    \centering
    \includegraphics[width=\textwidth, trim={0cm 0cm 0cm 0cm}, clip]{figures/lattices.pdf}
